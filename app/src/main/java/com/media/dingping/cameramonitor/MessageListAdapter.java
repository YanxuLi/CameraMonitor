...
public class MessageListAdapter extends BaseAdapter implements View.OnClickListener, OnCreateContextMenuListener,
    ...
    private MessageListAdapter(Context context, String deviceSerial) {
        mContext = context;
        mDeviceSerial = deviceSerial;
    }

    public MessageListAdapter(Context context, List<? extends Object> list, String deviceSerial) {
        ...
        if (i == R.id.message_layout) {
            ...
            if (mCheckMode) {
                ...
                if (mOnClickListener != null)
                    mOnClickListener
                            .onCheckClick(MessageListAdapter.this, checkBox, position, checkBox.isChecked());
            } else {
                if (mOnClickListener != null)
