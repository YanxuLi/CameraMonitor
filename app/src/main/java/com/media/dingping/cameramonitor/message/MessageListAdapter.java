...
public class MessageListAdapter extends BaseAdapter implements View.OnClickListener, OnCreateContextMenuListener,
    ...
    private MessageListAdapter(Context context, String deviceSerial,String devideVerifyCode) {
        mContext = context;
        mDeviceSerial = deviceSerial;
        mDevideVerifyCode = devideVerifyCode;
    }

    public MessageListAdapter(Context context, List<? extends Object> list, String deviceSerial,String devideVerifyCode,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (viewType == 0) {
                convertView = LayoutInflater.from(mContext).inflate(R.layout.message_list_section, parent, false);
                // 获取控件对象
...
//                        .getString(alarmType.getTextResId()));
        ...
        if (i == R.id.message_layout) {
            ...
            if (mCheckMode) {
                ...
                if (mOnClickListener != null)
                    mOnClickListener.onCheckClick(MessageListAdapter.this, checkBox, position, checkBox.isChecked());
            } else {
                if (mOnClickListener != null) {
                    mOnClickListener.onItemClick(MessageListAdapter.this, v, position);
                }
            }
            ...
            if (mOnClickListener != null)
                mOnClickListener.onCheckClick(MessageListAdapter.this, v, position, check);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        if (!mCheckMode && !mNoMenu) {
            ...
            if (mOnClickListener != null)
                mOnClickListener.onItemLongClick(MessageListAdapter.this, v, position);
        }
    }
